<template>
    <div class="g-date-picker" ref="wrapper" style="border:1px solid red;">
        <g-popover position="bottom" :container="popoverContainer" @open="onOpen" ref="popover">
            ...
            <template slot="content">
                <div :class="c('pop')" @selectstart.prevent>
                    ...
                    <div :class="c('actions')">
                        <g-button @click="mode = 'day'" v-if="mode === 'month'">返回</g-button>
...
export default {
    ...
    methods:{
        c(...className){
            return className.map(className => `g-date-range-picker-${className}`)
        },
        onInput(value){
        ...
        isSelected(date){
            ...
            let [y2,m2,d2] = helper.getYearMonthDate(this.value[0] || new Date())
    ...
    computed:{
        ...
        formattedValue(){
            ...
            const [year,month,day] = helper.getYearMonthDate(this.value[0] || new Date())
